  ...
  implements NetworkComponentAPI
{
  ...
  protected reduceMaxBufferLength(
    threshold: number,
    fragDuration: number,
  ): boolean;
...
export declare type BufferCreatedTrackSet = Partial<
...
export declare type FragmentLoadProgressCallback = (
...
export declare type HlsAssetPlayerConfig = Partial<HlsConfig> &
...
export declare interface InterstitialEventWithAssetList
  extends InterstitialEvent {
  assetListUrl: string;
}
...
export declare type InterstitialScheduleItem =
...
export declare class InterstitialsController
  extends Logger
  implements NetworkComponentAPI
{
...
export declare type SourceBufferTrackSet = Partial<
